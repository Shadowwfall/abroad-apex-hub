...
export const staff: Staff[] = [
  ...
  },
  {
    id: "ST-02",
    name: "Ravi Teja",
    email: "ravi@apexabroad.in",
    role: "Counsellor",
    branches: ["Banjara Hills HQ"],
    active: true,
    initials: "RT",
  },
  {
    id: "ST-03",
    name: "Divya Nair",
    email: "divya@apexabroad.in",
    role: "Branch Admin",
    branches: ["Ameerpet", "Kukatpally"],
    active: true,
    initials: "DN",
  },
  {
  ...
  },
  {
    id: "ST-06",
    name: "Suresh Babu",
    email: "suresh@apexabroad.in",
    role: "Finance",
    branches: ["Banjara Hills HQ", "Gachibowli"],
    active: false,
    initials: "SB",
  },
  {
...
export const activities: Activity[] = [
  ...
  },
  {
    ...
    user: "Neha Gupta",
    initials: "NG",
    action: "Uploaded IELTS scorecard for",
    target: "Zoya Ahmed",
    branch: "Ameerpet",
    time: "48 min ago",
    tone: "info",
  },
  {
    ...
    user: "Suresh Babu",
    initials: "SB",
    action: "Recorded payment ₹85,000 from",
    target: "Arjun Verma",
    branch: "Ameerpet",
    time: "2 hours ago",
    tone: "success",
  },
  {
    ...
    user: "Priya Menon",
    initials: "PM",
    action: "Marked passport copy pending for",
    target: "Karthik Rao",
    branch: "Gachibowli",
    time: "3 hours ago",
    tone: "warning",
  },
  {
    ...
    user: "Divya Nair",
    initials: "DN",
    action: "Converted lead to student",
    target: "Vikram Chawla",
    branch: "Ameerpet",
    time: "Yesterday",
    tone: "info",
  },
  {
    ...
    user: "Imran Khan",
    initials: "IK",
    action: "Processed refund ₹22,000 for",
    target: "Anjali Sharma",
    branch: "Kukatpally",
    time: "Yesterday",
    tone: "default",
  },
...
export const deadlines: Deadline[] = [
  ...
  {
    id: "d2",
    title: "Financial documents upload",
    student: "Rahul Yadav",
    due: "Today, 6:00 PM",
    bucket: "Today",
  },
